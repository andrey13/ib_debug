...
function createTabulatorSelectVocab(id_div, table, sort, ok, appH, allow, resolve, reject) {
    ...
    let cols = [
        ...
        { title: "", field: "name", editor: ed, widthGrow: 10, headerFilter: true, topCalc: "count" },
    ];
    ...
    if (table == 'kadri_prikaz') {
        cols = [
            //{ title: "id", field: "id",   widthGrow: 1,  headerFilter: true, },
            {
                title: "дата", field: "date", widthGrow: 1, headerFilter: true,
                editor: ed_date,
                sorter: "date",
            ...
            { title: "номер", field: "numb", editor: ed, widthGrow: 1, headerFilter: true, topCalc: "count" },
        ];
    }
    ...
    $("#bDel").click(function () {
        let r = tableVocab.getSelectedData()[0];
